 ...
 */
@Data
public class LivePrepareContractDto {
    /**
     * 品牌名称
     */
    ...
    private String  advanceStartPercent;

    private String advanceStartDay;

    private String advanceEndPercent;

    private String advanceEndDay;
